...
builder.Services.AddScoped<IServiceChecker, OracleSysdateChecker>();
builder.Services.AddScoped<IServiceChecker, OracleActiveSessionsChecker>();
builder.Services.AddScoped<IServiceChecker, OracleBlockedSessionsChecker>();
// DB İzleme Fazı 2 — üç platformda simetrik sağlık metrikleri
builder.Services.AddScoped<IServiceChecker, OracleLongQueriesChecker>();
builder.Services.AddScoped<IServiceChecker, OracleTablespaceStatusChecker>();
builder.Services.AddScoped<IServiceChecker, OracleConnectionUsageChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlGetDateChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlActiveSessionsChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlBlockedSessionsChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlLongQueriesChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlDbStatusChecker>();
builder.Services.AddScoped<IServiceChecker, MsSqlConnectionUsageChecker>();
builder.Services.AddScoped<IServiceChecker, MySqlNowChecker>();
builder.Services.AddScoped<IServiceChecker, MySqlActiveSessionsChecker>();
builder.Services.AddScoped<IServiceChecker, MySqlBlockedSessionsChecker>();
...
app.Use(async (ctx, next) =>
{
    ...
    bool open = path.StartsWithSegments("/Account")
                ...
                || path.StartsWithSegments("/Home/Error")     // hata sayfası gizlenmesin (yoksa hatalar login'e döner gibi görünür)

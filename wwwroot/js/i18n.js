...
(function () {
    ...
    Object.assign(TEXT, {
        ...
        "Kimlik doğrulama kullan (kullanıcı adı / şifre)": "Use authentication (username / password)",
        "TLS/SSL kullan (STARTTLS 587 / SSL 465)": "Use TLS/SSL (STARTTLS 587 / SSL 465)",
        "Kapalıysa açık SMTP relay (ör. port 25) kullanılır. Office365/Gmail gibi sağlayıcılar için kimlik doğrulama + TLS açın ve portu (587/465) elle girin.": "When off, an open SMTP relay (e.g. port 25) is used. For providers like Office365/Gmail, enable authentication + TLS and enter the port (587/465) manually.",

...
(function () {
    ...
    const TEXT = {
        ...
        "Görev adı *": "Job name *",
        "elle yazabilir veya \"Görevleri Listele\" ile sunucudan seçebilirsiniz": "type it manually or pick from the server with \"List Jobs\"",
    ...
    const PREFIX = {
        ...
        "Kalan Gün (": "Days Left (",
        "Son Koşu Süresi (": "Last Run Duration (",
        "Son Koşudan Bu Yana (": "Since Last Run (",
        "Listeden seç (": "Pick from list (",
        "Diskler (": "Disks (",
        "son: ": "last: ",
